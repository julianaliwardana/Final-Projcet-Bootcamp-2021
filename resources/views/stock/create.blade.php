...
@section('content')
<h1 class="text-white text-center pt-5"><i class='bx bxs-box' ></i> Add Stock</h1>

<div class="container-fluid w-75" id="createStock">
    <form action=" {{ route('store-stock') }} " method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mt-3">
            <div class="col">
                <p class="mb-2 mt-2 fw-bold">Item</p>
                <div class="input-group mb-3">
                    <input type="text" class="form-control @error('item') is-invalid @enderror" name="item" placeholder="Add Item">
                    @error('item')
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Add Price">
                    @error('price')
                        <div class="invalid-feedback bg-danger text-white rounded mt-2 p-2">{{$message}}</div>
                    @enderror
                </div>
